...
public class WPCommentContestPluginTest {
	...
	// �vitera de faire les init pour chaque navigateur
	@Before
	public void before() throws UtilsException {
		// TODO faire une m�thode utilitaire pour l'initialisation globale afin
		// de cr�er un framework g�n�rique de tests pour wordpress
